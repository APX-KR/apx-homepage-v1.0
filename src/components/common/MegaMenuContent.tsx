            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-left">
                <div>
                    ...
                    <ul className="space-y-3 mt-4">
                        <li><span onClick={() => navigate('/solutions#diagnose-structure')} className="cursor-pointer block text-body-base text-text-secondary font-medium hover:text-apx-growth-green">조직구조 진단</span></li>
                        ...
                        <li><span onClick={() => navigate('/solutions#diagnose-leadership')} className="cursor-pointer block text-body-base text-text-secondary font-medium hover:text-apx-growth-green">리더십 코어 역량 진단</span></li>
                    </ul>
                ...
                <div>
                    ...
                    <ul className="space-y-3 mt-4">
                        <li><span onClick={() => navigate('/solutions#strategy-mvc')} className="cursor-pointer block text-body-base text-text-secondary font-medium hover:text-apx-growth-green">M.V.C 재정립</span></li>
                        <li><span onClick={() => navigate('/solutions#strategy-org-redesign')} className="cursor-pointer block text-body-base text-text-secondary font-medium hover:text-apx-growth-green">조직구조 개편 및 R&R 재설계</span></li>
                        <li><span onClick={() => navigate('/solutions#strategy-role-based-hr')} className="cursor-pointer block text-body-base text-text-secondary font-medium hover:text-apx-growth-green">직무 중심 인사관리 체계 구축</span></li>
                        <li><span onClick={() => navigate('/solutions#strategy-workforce-planning')} className="cursor-pointer block text-body-base text-text-secondary font-medium hover:text-apx-growth-green">전략적 인력계획 수립</span></li>
                        <li><span onClick={() => navigate('/solutions#strategy-learning-system')} className="cursor-pointer block text-body-base text-text-secondary font-medium hover:text-apx-growth-green">전사 교육체계 설계</span></li>
                    </ul>
                ...
                <div>
                    ...
                    <ul className="space-y-3 mt-4">
                        <li><span onClick={() => navigate('/solutions#development-new-leader')} className="cursor-pointer block text-body-base text-text-secondary font-medium hover:text-apx-growth-green">신임 리더 온보딩 프로그램</span></li>
                        <li><span onClick={() => navigate('/solutions#development-coaching-leadership')} className="cursor-pointer block text-body-base text-text-secondary font-medium hover:text-apx-growth-green">성장 촉진을 위한 코칭 리더십</span></li>
                        <li><span onClick={() => navigate('/solutions#development-okr-leadership')} className="cursor-pointer block text-body-base text-text-secondary font-medium hover:text-apx-growth-green">목표 기반 성과관리 리더십 워크숍</span></li>
                        <li><span onClick={() => navigate('/solutions#development-onboarding')} className="cursor-pointer block text-body-base text-text-secondary font-medium hover:text-apx-growth-green">신규/경력 입사자 온보딩 프로그램</span></li>
                        <li><span onClick={() => navigate('/solutions#development-academy')} className="cursor-pointer block text-body-base text-text-secondary font-medium hover:text-apx-growth-green">공통역량 아카데미</span></li>
                    </ul>
...
const BpoServicesMegaMenu: React.FC = () => {
    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-left">
            <span onClick={() => navigate('/services#cfo-service')} className="group block cursor-pointer">
            ...
            <span onClick={() => navigate('/services#coo-service')} className="group block cursor-pointer">
            ...
            <span onClick={() => navigate('/services#package-service')} className="group block cursor-pointer">
